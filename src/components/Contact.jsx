  ...
  return (
    <section id='contact' className='section'>
      <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
        ...
        <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
          ...
          <div className='flex items-center gap-2 mt-auto'>
            {socialLinks.map(({ href, icon }, idx) => (
              <a key={idx} href={href} target='_blank' className='w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80'>
                {icon}
              </a>
            ))}
          </div>
        ...
        {/* --> Form */}
        <form action={import.meta.env.VITE_GETFORM_URL} method='POST' className='xl:pl-10 2xl:pl-20'>
            ...
            <div className='mb-4'>
              <div className=''>
                ...
                <input
                  ...
                  autoComplete='email'
                  required
                  placeholder='istiakahmedsaad.official@gmail.com'
                  className='text-field'
                />
              </div>
            </div>
          ...
          <div className="mb-4">
            ...
            <textarea name="message" id="message" placeholder='Enter your thought' required className="text-field resize-y min-h-32 max-h-80"></textarea>
          </div>
